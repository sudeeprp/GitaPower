...
Widget beginItem(String title, String about, Image image) {
  ...
  final titleText = Padding(padding: itemPadding,
    child: Text.rich(key: Key('begin/$title'), TextSpan(children: [
...
class BeginWidget extends StatelessWidget {
  ...
  Widget build(context) {
    return Column(children: [
      beginItem('notes', 'Follow the conversation by themes', Image.asset('images/begin-notes.png')),
