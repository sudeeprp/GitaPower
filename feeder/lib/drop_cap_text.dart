...
class DropCapText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextPainter textPainter =
        TextPainter(textDirection: textDirection, text: textSpan, textAlign: textAlign);
            ...
            children: <Widget>[
              ...
              Flexible(
                child: Container(
                  ...
                  child: RichText(
                    overflow:
                        (maxLines == null || (maxLines! > rows && overflow == TextOverflow.fade))
                            ? TextOverflow.clip
                            : overflow,
                    maxLines: maxLines,
                    textDirection: textDirection,
            ...
            Padding(
              ...
              child: RichText(
                ...
                text: TextSpan(
                  ...
                  children:
                      parseInlineMarkdown ? mdRest!.subchars(charIndexEnd).toTextSpanList() : null,
                  style: textStyle.apply(fontSizeFactor: MediaQuery.of(context).textScaleFactor),
                ),
              ),
            ),
