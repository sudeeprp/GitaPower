...
List<Widget> navigationButtons(BuildContext context, String thismd, String? nextmd, String? prevmd) {
  final ContentActions contentActions = Get.find();
  Widget makeNavigator(Alignment alignment, String? targetMdFilename, IconData icon) => Obx(() => Visibility(
